	...
	root_dir = function(bufnr, on_dir)
		...
		if cargo_crate_dir == nil then
			on_dir(
				...
				-- Standalone .rs file (no Cargo.toml / rust-project.json / .git):
				-- fall back to its own directory so rust-analyzer can run in
				-- detached/standalone mode instead of hanging with no root.
